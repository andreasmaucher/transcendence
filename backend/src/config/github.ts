//// filepath: /Users/mrizhakov/Documents/42/transcendence/backend/src/config/github.ts
import fs from "fs";
...
export const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_ID || clientIdFromFile || "";

export const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || secretFromFile || "";
