...
export const FUJI_CHAIN_ID_HEX: string = (import.meta as any).env
  ?.VITE_AVALANCHE_FUJI_CHAIN_ID_HEX as string;
export const VITE_FUJI_RPC_URL: string = (import.meta as any).env
  ?.VITE_FUJI_RPC_URL as string;
        ...
        params: [
          {
            ...
            rpcUrls: [
              (import.meta as any).env?.VITE_FUJI_RPC_URL ||
